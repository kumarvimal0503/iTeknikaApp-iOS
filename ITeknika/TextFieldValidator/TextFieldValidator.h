...
#define REGEX_USER_NAME @"[A-Za-z0-9]{3,20}"
...
#define REGEX_RESTAURANT_NAME @"[A-Za-z0-9]{0,50}"
#define REGEX_RESTAURANT_NAME_LIMIT @"^.{0,50}$"
#define REGEX_CUISINE @"[a-zA-Z\\s+ +,]*"
#define REGEX_LOCATION @"[A-Za-z0-9+ +,+-]{0,50}"
#define REGEX_CUISINE_LIMIT @"^.{0,100}$"
/**
